let students = [
    { ID: 1, name: 'Alice', age: 21, grade: 8.12, degree: 'Btech', email: 'alice@example.com' },
    { ID: 2, name: 'Bob', age: 22, grade: 9.3, degree: 'MBA', email: 'bob@example.com' },
    { ID: 3, name: 'Charlie', age: 20, grade: 7.5, degree: 'Arts', email: 'charlie@example.com' }
];
let addStudent ;
let editStudent ;
let searchField ;
...
(function load(){
    ...
    for(x in students){
        ...
        <img  id="edit-btn" onclick="edit(${students[x].ID})" src="images/edit-logo.svg"> <img onclick="deleteStudent(${students[x].ID})" src="images/delete-logo.svg"></td></tr>`
    }
...
addStudent.addEventListener('click',function(){
    ...
    for(x in students){
        write = write+`<tr><td>${students[x].ID}</td><td>${students[x].name}</td><td>${students[x].email}</td><td>${students[x].age}</td><td>${students[x].grade}</td><td>${students[x].degree}
        <img  id="edit-btn" onclick="edit(${students[x].ID})" src="images/edit-logo.svg"> <img src="images/delete-logo.svg"></td></tr>`
    }
...
function searchStudents(){
    ...
    for(x in filter){
        ...
        <img  id="edit-btn" onclick="edit(${filter[x].ID})" src="images/edit-logo.svg"> <img onclick="deleteStudent(${filter[x].ID})" src="images/delete-logo.svg"></td></tr>`
    }
